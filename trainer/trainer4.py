...
class Trainer(object):
	...
	def _train_batch(self, model, batch_items,noise_configs):
		...
		for bidx in range(n_minibatch):
			...
			with open("/home/alta/BLTSpeaking/exp-yw575/GEC/AttackGram/dataset/nearest/dev_pred_v1.txt","a+") as f:
				for i in range(len(preds)):
					f.write(preds[i]+"\n")
				f.close()
			with open("/home/alta/BLTSpeaking/exp-yw575/GEC/AttackGram/dataset/nearest/dev_src_v1.txt","a") as f:
				for i in range(len(srcs)):
					f.write(srcs[i]+"\n")
				f.close()
			with open("/home/alta/BLTSpeaking/exp-yw575/GEC/AttackGram/dataset/nearest/dev_tgt_v1.txt","a") as f:
